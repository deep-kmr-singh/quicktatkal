		...
		<div id="register_form" align="center" height="200" width="200">
			...
			<form action="#" method="post"> 
				...
				<table border="2px solid black;">
					...
					<tr>
						...
						<td><input size="30" name="train_name" type="text" id="train_name" placeholder="Enter the train name..."></td>
					</tr>
					
				</table>
				<br><br>
				<button class="button" name="submit" type="submit"><b>DELETE TRAIN</b></button><br>
			...
			<?php 
				if(isset($_REQUEST['submit'])){
					...
					$sql = "DELETE FROM train_list where train_no='$train_no'";
